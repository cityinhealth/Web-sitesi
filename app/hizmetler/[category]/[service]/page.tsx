...
export default async function ServicePage({ params }: { params: Promise<{ category: string; service: string }> }) {
    ...
    const faqs = [
        ...
        { question: `${svc.title} hangi ilçelerde sunuluyor?`, answer: `İstanbul'un 39 ilçesinin tamamında 7/24 ${svc.title.toLowerCase()} hizmeti veriyoruz. Adalar ilçesi dahil Avrupa ve Anadolu yakasındaki tüm lokasyonlara ulaşıyoruz.` },
